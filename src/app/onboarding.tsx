...
export default function Onboarding() {
	...
	return (
		<View className="flex-1">
			...
			<FlatList ref={flatListRef} data={onboardingData} renderItem={({ item }) => <OnboardingItem {...item} />} horizontal showsHorizontalScrollIndicator={false} pagingEnabled bounces={false} keyExtractor={(item) => item.title} onScroll={handleScroll} scrollEventThrottle={16} />
