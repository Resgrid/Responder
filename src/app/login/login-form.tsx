		...
		<KeyboardAvoidingView style={{ flex: 1 }} behavior="padding" keyboardVerticalOffset={10}>
			<View className="flex-1 justify-center p-4">
				<View className="items-center justify-center">
					...
					<Text className="mb-6 max-w-xl text-center text-gray-500">To login in to the Resgrid Responder app, please enter your username and password. Resgrid Responder is an app designed to allow a person to interact with their orginization in the Resgrid system.</Text>
				</View>
				<FormControl isInvalid={!!errors?.username || !validated.usernameValid} className="w-full">
					...
					<Controller
						...
						render={({ field: { onChange, onBlur, value } }) => (
							<Input>
								<InputField placeholder={t("login.username_placeholder")} value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} returnKeyType="done" autoCapitalize="none" autoComplete="off" />
							</Input>
						)}
					/>
					<FormControlError>
				...
				<FormControl isInvalid={!!errors.password || !validated.passwordValid} className="w-full">
					...
					<Controller
						...
						render={({ field: { onChange, onBlur, value } }) => (
							<Input>
								<InputField type={showPassword ? "text" : "password"} placeholder={t("login.password_placeholder")} value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} returnKeyType="done" autoCapitalize="none" autoComplete="off" />
