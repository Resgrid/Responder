...
describe('MessagesStore', () => {
	...
	describe('fetchMessages', () => {
		it('should fetch messages successfully', async () => {
			mockedApi.getAllMessages.mockResolvedValue({
				Data: mockMessages,
				PageSize: 0,
		...
		it('should handle fetch messages error', async () => {
			...
			mockedApi.getAllMessages.mockRejectedValue(new Error(errorMessage));
	...
	describe('deleteMessages', () => {
		it('should delete messages successfully', async () => {
			...
			useMessagesStore.setState({ messages: mockMessages });
	...
	describe('Computed Properties', () => {
		...
		it('should filter messages correctly', () => {
			...
			// Test inbox filter (non-system messages)
			act(() => {
				result.current.setCurrentFilter('inbox');
			});
			...
			expect(filtered[0].MessageId).toBe('1');

			// Test sent filter (system messages)
			act(() => {
