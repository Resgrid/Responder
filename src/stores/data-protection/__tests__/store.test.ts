...
// Capture the reset callback registered at module load.
// eslint-disable-next-line no-var
var mockResetFn: (() => void) | undefined;
...
describe('dataProtectionStore', () => {
  ...
  describe('window lifecycle', () => {
    ...
    it('logout reset drops everything — the grant is memory-only', () => {
      dataProtectionStore.setState({
      ...
      expect(mockResetFn).toBeDefined();
      mockResetFn?.();
